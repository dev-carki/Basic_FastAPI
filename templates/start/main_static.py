...
app.mount('/templates/start/static', StaticFiles(directory='templates/start/static'), name='static')

# jinja2 Template 생성. 인자로 directory 입력
templates = Jinja2Templates(directory="templates/start/templates")
